...
namespace FunnyMaps.Server.Migrations
{
    ...
    [Migration("20240820192404_UserUpdateEmailFix")]
    partial class UserUpdateEmailFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FunnyMaps.Server.Models.Joke", b =>
                {
                    b.HasOne("FunnyMaps.Server.Models.User", "User")
                        .WithMany("Jokes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FunnyMaps.Server.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
